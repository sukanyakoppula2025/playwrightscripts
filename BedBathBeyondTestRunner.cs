...
{
    class BedBathBeyondTestRunner
    {
        static async Task Main(string[] args)
        {
            Console.WriteLine("🛏️  Bed Bath & Beyond Login Test Runner");
            Console.WriteLine("========================================");
            
            // Get credentials from user input (in production, use secure methods)
            Console.Write("Enter Bed Bath & Beyond account email: ");
            ...
            using var bedBathTest = new BedBathBeyondLoginTest();
            var result = await bedBathTest.RunBedBathBeyondLoginTestAsync(email, password, keepBrowserOpen: true);
